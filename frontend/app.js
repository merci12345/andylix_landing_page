...
waitlistForm.addEventListener("submit", async (e) => {
  ...
  try {
    ...
    formMsg.textContent = "❌ Erreur réseau. Vérifie que le backend tourne sur localhost:4000.";
  }
});
...
document.querySelectorAll(".chip.pick").forEach(btn => {
  btn.addEventListener("click", () => {
    document.querySelectorAll(".chip.pick").forEach(b => b.classList.remove("selected"));
